		...
		<CardContent>
				<>
					<div className='w-full h-full p-2 overflow-y-auto bg-slate-50 border border-slate-300 rounded-lg dark:bg-slate-1000 dark:border-slate-800'>
						...
						{
							return (
								<div className={'flex items-center gap-2 w-full px-3 py-1 rounded-lg ' + (participant.creator && 'bg-amber-300 text-amber-900')} key={index}>
									{participant.creator &&
				...
				<div className='w-full flex flex-row items-center justify-center gap-4'>
					...
					<div className='flex flex-col'>
						...
						<div className='flex dark:gap-2 items-center'>
							...
							<div data-content={!copy ? "Copy!" : "Copied!"} className={'tooltip bottom  ' + (copy && 'success')}>
